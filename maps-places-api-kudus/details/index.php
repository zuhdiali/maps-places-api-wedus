...
// } else {
//     echo "Variable provided: " . htmlspecialchars($var);
// }
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Cari Tempat Wisata</h4>
                                    <div class="form-group">
                                        <input
                                            type="text"
                                            class="form-control"
                                            placeholder="Cari tempat wisata di Kudus..."
                                            id="search-input" />
                                    </div>
                        ...
                        <div class="col-md-4 stretch-card grid-margin">
                            <a href="" class="text-decoration-none">
                                <div class="card">
                                    <div class="card-body">
                                        <img
                                            src="images/dashboard/people.svg"
                                            alt="Tempat Wisata"
                                            class="img-fluid rounded mb-3" />
                                        <h4 class="text-black">Curug Winong 2</h4>
                                        <p class="text-black">
                                            Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                                            Dolore, facere.
                                        </p>
                                        <small class="text-black">Alamat</small>
                                    </div>
                                </div>
                            </a>
                        </div>
        ...
        $(document).ready(function() {
            $('#search-button').click(function() {
                ...
                if (searchTerm) {
                    try {
                        $.ajax({
                            url: 'proxy.php', // URL to your proxy script
                            method: 'POST',
                                ...
                                if (data.places && data.places.length > 0) {
                                    data.places.forEach(function(item) {
                                        $('#search-results').append(
                                            ...
                                            '<div class="card">' +
                                            '<div class="card-body">' +
                                            '<a href="details.php?place_id=' + encodeURIComponent(item.id) + '" class="text-decoration-none">' +
                                            '<img src="https://places.googleapis.com/v1/' + item.photos[0].name + '/media?key=' + "<?php echo $apiKey ?>" + '&maxWidthPx=470" alt="Tempat Wisata" class="img-fluid rounded mb-3" />' +
                                            '<h4>' + item.displayName.text + '</h4>' +
                                            '<p>' + (item.description || 'No description available.') + '</p>' +
                                            '<small>' + (item.formattedAddress || 'Alamat tidak tersedia') + '</small>' +
                                            '</a>' +
                                            '</div>' +
                                            '</div>' +
                                            '</div>'
                        ...
                        $('#search-results').append('<li class="list-group-item">An unexpected error occurred.</li>');
                    }
                } else {
                    $('#search-results').append('<li class="list-group-item">Tolong masukkan kode pencarian.</li>');
                }
            });
        });
    </script>
